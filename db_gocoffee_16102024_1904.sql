...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 16, 2024 at 02:03 PM
...
--
-- Indexes for table `merchantcoffees`
--
ALTER TABLE `merchantcoffees`
  ADD PRIMARY KEY (`id`),
...
--
-- AUTO_INCREMENT for table `merchantcoffees`
--
ALTER TABLE `merchantcoffees`
...
--
-- Constraints for table `merchantcoffees`
--
ALTER TABLE `merchantcoffees`
  ADD CONSTRAINT `merchantCoffees_ibfk_1` FOREIGN KEY (`merchantID`) REFERENCES `merchants` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `merchantCoffees_ibfk_2` FOREIGN KEY (`coffeeID`) REFERENCES `coffees` (`id`) ON UPDATE CASCADE;

--
-- Constraints for table `merchants`
--
ALTER TABLE `merchants`
  ADD CONSTRAINT `Merchants_ibfk_1` FOREIGN KEY (`userID`) REFERENCES `users` (`id`) ON UPDATE CASCADE;
...
ALTER TABLE `orders`
  ...
  ADD CONSTRAINT `Orders_ibfk_2` FOREIGN KEY (`merchantID`) REFERENCES `merchants` (`id`) ON DELETE SET NULL ON UPDATE CASCADE;
